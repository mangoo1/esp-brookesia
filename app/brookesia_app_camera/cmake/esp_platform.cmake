...
target_link_libraries(${COMPONENT_LIB} PUBLIC "-u app_camera_provider_symbol")
...
brookesia_system_core_get_esp_runtime_app_stage_root(app_camera_stage_root)
brookesia_stage_runtime_app_package(
    PACKAGE_ID "${app_camera_package_id}"
    SOURCE_DIR "${COMPONENT_DIR}/package"
    STAGE_ROOT "${app_camera_stage_root}"
    NO_INDEX
)
